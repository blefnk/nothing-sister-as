...
- **🚀 Live Demo**: [nothing-sister-as.vercel.app](https://nothing-sister-as.vercel.app/en)
- **💙 Discord**: [discord.gg/Pb8uKbwpsJ](https://discord.gg/Pb8uKbwpsJ)
- **📚 Docs**: [docs.reliverse.org](https://docs.reliverse.org/nothing-sister-as)
...
1. `git clone https://github.com/blefnk/nothing-sister-as.git`
2. `cd nothing-sister-as`
3. `bun i`
